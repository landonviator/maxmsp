...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 522.0, 512.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1151.0, 513.0, 88.0, 22.0 ],
					"text" : "onepole~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1099.0, 482.333331882953644, 29.5, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1099.0, 434.0, 88.0, 22.0 ],
					"text" : "onepole~ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1817.0, 532.0, 290.0, 33.0 ],
...
,
					"patching_rect" : [ 1497.0, 562.0, 58.0, 23.0 ],
...
,
					"patching_rect" : [ 1477.0, 537.0, 110.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1464.0, 613.0, 483.0, 273.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1693.0, 537.0, 123.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/land00m/Documents/GitHub/maxmsp/Modeling/Audio/OD-Cycle.aif",
								"filename" : "OD-Cycle.aif",
								"filekind" : "audiofile",
								"id" : "u994004811",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 945.0, 613.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 774.0, 426.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 745.0, 722.0, 613.0, 190.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 645.5, 590.333331882953644, 73.0, 22.0 ],
					"text" : "record 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 601.0, 590.333331882953644, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 601.0, 631.333332061767578, 59.0, 22.0 ],
					"text" : "sfrecord~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1719.0, 69.0, 290.0, 33.0 ],
					"style" : "helpfile_label",
					"text" : "Your signal vector size must be 1/4 the FFT size or smaller for this patcher to work correctly!"
				}
...
,
					"patching_rect" : [ 1399.0, 99.0, 58.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
,
					"patching_rect" : [ 1379.0, 74.0, 110.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1366.0, 150.0, 483.0, 273.0 ],
					"rangelabel" : "Magnitude (dB)",
					"subplots" : [ 						{
							"color" : [ 0.4, 0.4, 0.75, 1.0 ],
							"thickness" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 1595.0, 74.0, 123.0, 23.0 ],
					"text" : "windowed-fft~ 1024"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 16.000000476837158, 247.333340704441071, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.333337664604187, 254.000007569789886, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.666674256324768, 473.33334743976593, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.25, 334.000009953975677, 39.0, 22.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 202.000006020069122, 688.000020503997803, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.5, 482.333331882953644, 73.0, 22.0 ],
					"text" : "record 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 482.333331882953644, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 27.0, 523.333332061767578, 59.0, 22.0 ],
					"text" : "sfrecord~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 587.333332061767578, 29.5, 22.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 587.333332061767578, 29.5, 22.0 ],
					"text" : "-1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 587.333332061767578, 35.0, 22.0 ],
					"text" : "2000"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 640.333332061767578, 124.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 65.0, 933.0, 136.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 27.0, 714.333332061767578, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 762.333332061767578, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 90.333334267139435, 156.66666841506958, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 27.0, 22.0, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 141.5, 663.0, 240.0, 663.0, 240.0, 468.0, 264.166674256324768, 468.0 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 75.5, 621.0, 3.0, 621.0, 3.0, 243.0, 25.500000476837158, 243.0 ],
					"order" : 1,
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 81.0, 516.0, 444.0, 516.0, 444.0, 576.0, 655.0, 576.0 ],
					"order" : 0,
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"midpoints" : [ 31.75, 468.0, 12.0, 468.0, 12.0, 519.0, 36.5, 519.0 ],
					"order" : 3,
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 31.75, 366.0, 276.0, 366.0, 276.0, 60.0, 298.5, 60.0 ],
					"order" : 2,
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 264.166674256324768, 498.0, 186.0, 498.0, 186.0, 234.0, 25.500000476837158, 234.0 ],
					"source" : [ "obj-39", 0 ]
				}
